...
#define _POSIX_C_SOURCE __INT_MAX__ /* yes i know this is awful :3 */
...
void* player_func(void* threadarg) {
	...
	// this code actually makes me want to scoop my eyes out with melon ballers.
	// if you ever do something like this in the real world, you should be fired.
	...
	// i love how literally every thread finds the exact same max score.
